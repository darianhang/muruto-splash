...
import { ALT_COLOR, ALT_COLOR_DARK, ALT_COLOR_LIGHT } from "@/app/page";
...
const Star = React.forwardRef<HTMLDivElement, SVGProps>(
  ({ color, top, bottom, left, right, size = 40, x, y }, ref) => {
    return (
      <div
        ref={ref}
        style={{
...
const Circle = React.forwardRef<HTMLDivElement, SVGProps>(
  ({ color, top, bottom, left, right, size = 40, x, y }, ref) => {
    return (
      <div
        ref={ref}
